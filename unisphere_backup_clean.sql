...
ALTER TABLE IF EXISTS ONLY public.bids DROP CONSTRAINT IF EXISTS "FK_f1984b1eaacbd832c4905b13499";
ALTER TABLE IF EXISTS ONLY public.rfps DROP CONSTRAINT IF EXISTS "FK_e646fa8cfb276fef5883a18b101";
ALTER TABLE IF EXISTS ONLY public.rfps DROP CONSTRAINT IF EXISTS "FK_d9d8d8c6f13dbdceaee0a81ebc0";
ALTER TABLE IF EXISTS ONLY public.milestones DROP CONSTRAINT IF EXISTS "FK_b6d0284fa612b38d1f7910cfff2";
ALTER TABLE IF EXISTS ONLY public.rfps DROP CONSTRAINT IF EXISTS "FK_b5bed400c9a9a11f04cdffb0c1d";
ALTER TABLE IF EXISTS ONLY public.milestone_updates DROP CONSTRAINT IF EXISTS "FK_9014c95c55f2eeac4007f398598";
ALTER TABLE IF EXISTS ONLY public.rfps DROP CONSTRAINT IF EXISTS "FK_7ed0c84fcc5c0d880359f4b5959";
ALTER TABLE IF EXISTS ONLY public.milestone_updates DROP CONSTRAINT IF EXISTS "FK_7c73136529cb3df4a7042761c3a";
ALTER TABLE IF EXISTS ONLY public.milestone_updates DROP CONSTRAINT IF EXISTS "FK_7aebe522b5b735ccd8414c9e6b7";
ALTER TABLE IF EXISTS ONLY public.contracts DROP CONSTRAINT IF EXISTS "FK_5c3066bc3ec3f547c4ab0ae04b3";
ALTER TABLE IF EXISTS ONLY public.contracts DROP CONSTRAINT IF EXISTS "FK_5b25d57839e5465600cbb144f48";
ALTER TABLE IF EXISTS ONLY public.bids DROP CONSTRAINT IF EXISTS "FK_3fc39feeb36f0b031c90c73003c";
ALTER TABLE IF EXISTS ONLY public.contracts DROP CONSTRAINT IF EXISTS "FK_2bacffbaf8cdac1c2f4372a286e";
ALTER TABLE IF EXISTS ONLY public.rfp_categories DROP CONSTRAINT IF EXISTS "UQ_9f0d27b29f8f9c394e267d86ba5";
...
ALTER TABLE IF EXISTS ONLY public.bids DROP CONSTRAINT IF EXISTS "PK_7950d066d322aab3a488ac39fe5";
ALTER TABLE IF EXISTS ONLY public.rfps DROP CONSTRAINT IF EXISTS "PK_77f2177bb7367550c946f8ef0c8";
ALTER TABLE IF EXISTS ONLY public.milestone_updates DROP CONSTRAINT IF EXISTS "PK_5bdb25e7fdcc82b341827bc115b";
ALTER TABLE IF EXISTS ONLY public.rfp_categories DROP CONSTRAINT IF EXISTS "PK_44d57258299ba27a347562ebdce";
ALTER TABLE IF EXISTS ONLY public.contracts DROP CONSTRAINT IF EXISTS "PK_2c7b8f3a7b1acdd49497d83d0fb";
ALTER TABLE IF EXISTS ONLY public.milestones DROP CONSTRAINT IF EXISTS "PK_0bdbfe399c777a6a8520ff902d9";
ALTER TABLE IF EXISTS public.migrations ALTER COLUMN id DROP DEFAULT;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.rfps;
DROP TABLE IF EXISTS public.rfp_categories;
DROP TABLE IF EXISTS public.milestones;
DROP TABLE IF EXISTS public.milestone_updates;
DROP SEQUENCE IF EXISTS public.migrations_id_seq;
DROP TABLE IF EXISTS public.migrations;
DROP TABLE IF EXISTS public.contracts;
DROP TABLE IF EXISTS public.bids;
DROP TYPE IF EXISTS public.users_role_enum;
DROP TYPE IF EXISTS public.rfps_status_enum;
DROP TYPE IF EXISTS public.milestones_status_enum;
DROP TYPE IF EXISTS public.milestone_updates_status_enum;
DROP TYPE IF EXISTS public.contracts_status_enum;
DROP TYPE IF EXISTS public.bids_status_enum;
